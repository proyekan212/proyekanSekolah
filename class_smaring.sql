...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 28, 2021 at 07:45 AM
...
--
-- Dumping data for table `absen_gurus`
--

INSERT INTO `absen_gurus` (`id`, `kelas_mapel_id`, `guru_id`, `pertemuan`, `status`, `absen_at`, `created_at`, `updated_at`) VALUES
(1, 32, 2, 1, 'masuk', NULL, '2021-07-11 17:14:21', '2021-07-11 17:14:21'),
(2, 32, 2, 1, 'masuk', NULL, '2021-07-11 17:52:00', '2021-07-11 17:52:00'),
(3, 32, 2, 2, 'masuk', NULL, '2021-07-11 17:52:04', '2021-07-11 17:52:04'),
(4, 32, 2, 3, 'masuk', NULL, '2021-07-11 17:53:01', '2021-07-11 17:53:01'),
(5, 32, 2, 4, 'masuk', NULL, '2021-07-11 19:11:33', '2021-07-11 19:11:33'),
(6, 38, 5, 1, 'masuk', NULL, '2021-07-12 09:28:28', '2021-07-12 09:28:28');
...
(16, 39, 10, 1, '2021-07-27 22:34:17', '2021-07-27 22:34:17'),
(17, 40, 10, 1, '2021-07-27 22:34:17', '2021-07-27 22:34:17'),
(18, 41, 10, 1, '2021-07-27 22:34:17', '2021-07-27 22:34:17'),
(19, 8, 12, 1, '2021-07-27 22:36:19', '2021-07-27 22:36:19'),
(20, 13, 12, 1, '2021-07-27 22:36:20', '2021-07-27 22:36:20'),
(21, 19, 12, 1, '2021-07-27 22:36:20', '2021-07-27 22:36:20');
...
(8, 1, 6, 6, 2, '2021-07-11 19:14:48', '2021-07-12 09:04:05'),
...
(12, 0, 1, 6, 2, '2021-07-12 09:04:58', '2021-07-12 09:04:58');
...
(12, 5, 7, '2021-07-27 22:41:12', '2021-07-27 22:41:12'),
(13, 7, 7, '2021-07-27 22:41:12', '2021-07-27 22:41:12');
...
--
-- Table structure for table `kompetensi_dasar_per_kelas`
--

CREATE TABLE `kompetensi_dasar_per_kelas` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `kelas_mapel_id` int(11) NOT NULL,
...
--
-- Dumping data for table `kompetensi_dasar_per_kelas`
--

INSERT INTO `kompetensi_dasar_per_kelas` (`id`, `kelas_mapel_id`, `kompetensi_dasar_id`, `kompetensi_inti_id`, `semester_id`, `created_at`, `updated_at`) VALUES
(1, 38, 1, 1, 1, '2021-07-27 20:49:34', '2021-07-27 20:49:34'),
(2, 38, 2, 1, 1, '2021-07-27 20:49:34', '2021-07-27 20:49:34'),
(3, 38, 5, 2, 1, '2021-07-27 20:49:34', '2021-07-27 20:49:34'),
(4, 38, 6, 1, 1, '2021-07-27 20:49:34', '2021-07-27 20:49:34'),
(5, 38, 7, 2, 1, '2021-07-27 20:49:34', '2021-07-27 20:49:34'),
(6, 42, 1, 1, 1, '2021-07-27 22:39:52', '2021-07-27 22:39:52'),
(7, 42, 2, 1, 1, '2021-07-27 22:39:52', '2021-07-27 22:39:52'),
(8, 42, 5, 2, 1, '2021-07-27 22:39:52', '2021-07-27 22:39:52'),
(9, 42, 6, 1, 1, '2021-07-27 22:39:52', '2021-07-27 22:39:52'),
(10, 42, 7, 2, 1, '2021-07-27 22:39:52', '2021-07-27 22:39:52');
...
CREATE TABLE `master_jadwal_pelajarans` (
  ...
  `user_id` int(11) NOT NULL,
  `kompetensi_dasar_id` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `master_jadwal_pelajarans` (`id`, `kelas_id`, `semester_id`, `mapel_id`, `pertemuan`, `current_pertemuan`, `hapus`, `kkm`, `user_id`, `kompetensi_dasar_id`, `created_at`, `updated_at`) VALUES
(25, 3, 1, 2, 16, NULL, 0, 75, 2, NULL, '2021-06-08 01:59:36', '2021-06-08 01:59:36'),
(26, 3, 1, 3, 16, NULL, 0, 75, 2, NULL, '2021-06-08 02:00:08', '2021-06-08 02:00:08'),
(27, 3, 1, 1, 16, NULL, 0, 75, 2, NULL, '2021-06-08 02:00:23', '2021-06-08 02:00:23'),
(28, 4, 1, 3, 16, NULL, 0, 75, 7, NULL, '2021-06-13 00:55:48', '2021-06-13 00:55:48'),
(29, 4, 1, 2, 16, NULL, 0, 75, 2, NULL, '2021-06-19 04:13:21', '2021-06-19 04:13:21'),
(30, 6, 1, 2, 16, NULL, 0, 75, 2, NULL, '2021-06-19 04:14:03', '2021-06-19 04:14:03'),
(31, 4, 1, 1, 16, NULL, 0, 75, 2, NULL, '2021-06-19 04:14:24', '2021-06-19 04:14:24'),
(38, 12, 1, 1, 16, 1, 0, 75, 7, NULL, '2021-07-12 09:07:28', '2021-07-12 09:28:28'),
(39, 12, 1, 3, 16, NULL, 0, 75, 7, NULL, '2021-07-12 09:07:39', '2021-07-12 09:07:39'),
(40, 12, 1, 2, 16, NULL, 0, 75, 7, NULL, '2021-07-12 09:07:57', '2021-07-12 09:07:57'),
(41, 12, 1, 5, 16, NULL, 0, 75, 7, NULL, '2021-07-12 09:08:07', '2021-07-12 09:08:07'),
(42, 12, 1, 4, 16, NULL, 0, 75, 11, NULL, '2021-07-27 22:29:54', '2021-07-27 22:29:54');
...
(7, 1, 'Praktik', NULL, 'asasa', 42, 0, '2021-07-01', '2021-07-02', '2021-07-27 22:41:12', '2021-07-27 22:41:12');
...
(7, 'pertermuan 1', 2, 80, 'saasaasa', 42, 0, 1, '2021-06-30 17:00:00', '2021-07-01 17:00:00', '2021-07-27 22:40:28', '2021-07-27 22:40:28');
...
(2, 'nK_9-oOAI0g', 'testing', 'video', 'dasdasdasd', 38, 0, 0, 7, 12, '2021-07-12 09:36:50', '2021-07-12 09:36:50');
...
(1, 'Teacher', 'teacher', 'Teacher', 0, NULL, 1, '2021-01-07 02:55:56', '2021-07-12 09:38:29', NULL),
(2, 'Teacher', '/matapelajaran', 'Mata Pelajaran', 0, 'book', 1, '2021-01-07 02:56:10', '2021-07-12 09:38:10', NULL),
(3, 'Teacher', '/materi', 'Materi dan Bahan', 0, 'book-open', 2, '2021-01-07 02:56:20', '2021-07-12 09:38:16', NULL),
(4, 'Teacher', '/absen', 'Absensi Guru', 0, 'activity', 3, '2021-01-07 02:56:20', '2021-07-12 09:38:20', NULL),
...
(32, 'RPP', '/RPP_Admin', 'RPP', 1, NULL, 1, '2021-07-12 09:37:39', '2021-07-12 09:37:39', NULL);
...
(18, 'Kelas', '/kelas/absen_guru', 'Absen Guru', 1, 'book', 6, '2021-01-11 06:54:05', '2021-01-18 04:53:40', NULL),
(19, 'Menu Utama', '/dashboard', 'Keluar Kelas', 1, 'log-out', 1, '2021-07-12 09:40:42', '2021-07-12 09:40:42', NULL);
...
(39, 32, 1, '2021-07-14 08:45:59', '2021-07-14 08:45:59', NULL);
...
(84, 19, 2, '2021-07-14 08:49:31', '2021-07-14 08:49:31', NULL);
...
(127, '2021_07_11_230918_create_absen_gurus_table', 67),
(128, '2021_07_27_181846_create_kompetensi_dasar_per_kelas_table', 68),
(130, '2021_07_28_023928_create_kompetensi_dasar_per_kelas_table', 69),
(131, '2021_07_07_080600_create_teacher_notifications_table', 70),
...
(1, 10, 11, 'tugas pengetahuan ', 42, 0, '2021-07-27 22:40:28', '2021-07-27 22:40:28'),
(2, 33, 11, 'tugas pengetahuan ', 42, 0, '2021-07-27 22:40:28', '2021-07-27 22:40:28'),
(3, 59, 11, 'tugas pengetahuan ', 42, 0, '2021-07-27 22:40:28', '2021-07-27 22:40:28'),
(4, 10, 11, 'tugas keterampilan ', 42, 0, '2021-07-27 22:41:11', '2021-07-27 22:41:11'),
(5, 33, 11, 'tugas keterampilan ', 42, 0, '2021-07-27 22:41:12', '2021-07-27 22:41:12'),
(6, 59, 11, 'tugas keterampilan ', 42, 0, '2021-07-27 22:41:12', '2021-07-27 22:41:12');
...
(1, '4892118481', '$2y$10$VtSxgzGRFmmAxsbOanQJpe4PoQOqtvGJ53RRo1nPuAJpd87rOu8.e', NULL, NULL, NULL, '2021-07-27 22:37:08', 0, 0),
(2, '9630159739', '$2y$10$jogAhsur6Si7jFJ9IcqBFe9RykIRw0tdqtYl3rMOgtO00MNAFjE3e', NULL, NULL, NULL, '2021-07-27 22:33:12', 0, 0),
...
(7, '222222', '$2y$10$JWFeuBSaWGMckKr4l3oqee36fXI0DH2BCTudQy8EGMnY5sRIgLsh6', NULL, NULL, '2021-04-19 08:19:29', '2021-07-27 22:25:24', 0, 0),
(8, '3123124124', '$2y$10$PAyngHaRebsHcTAiH9Ey5O8mttoT8NoY3p/9G5tFn6c2F5QC08asm', NULL, NULL, '2021-04-19 09:00:06', '2021-07-27 22:32:22', 0, 0),
...
(11, '199009052019031024', '$2y$10$h/XX2QpXznIdEk9NRuQ3/eikD6OejDJgYMkto85aPBA428OWg8PpO', NULL, NULL, '2021-06-17 07:23:06', '2021-07-27 22:45:25', 0, 0),
...
(59, '74816348123', '$2y$10$PVfID2MEXk8YarT29YTzw.JI6JkVlbtk9x89hOcxtWMfb5XB1QyzW', NULL, NULL, '2021-06-21 23:58:58', '2021-07-27 22:45:04', 0, 0),
(72, '9876', '$2y$10$RVTtJzbJj2oRGdt61cjOH.OU9P3c6jxXzwGnfEx0poLkh7UvMgh5m', NULL, NULL, '2021-07-13 23:28:14', '2021-07-13 23:28:14', 0, 0),
(73, '8765', '$2y$10$meepmDv3/hjyE3.IYzpLBu4p8DL4Dqzhro9CSfCoUPNF9LN1H082C', NULL, NULL, '2021-07-13 23:28:14', '2021-07-13 23:28:14', 0, 0),
(74, '7654', '$2y$10$O52x4BA5cljWFJPFieNvi./umfeAI2b34Wbn/vuxFDE5Rj4nVOkFe', NULL, NULL, '2021-07-13 23:28:15', '2021-07-13 23:28:15', 0, 0),
(84, '1234', '$2y$10$5K5w8oeRtMyF0.1TEXD3l.fsQ4QkisnfWwfEoWgNPEQ6F29Dghih2', NULL, NULL, '2021-07-14 00:32:37', '2021-07-14 01:30:22', 0, 0),
(85, '2345', '$2y$10$1kyzbnmCAENovdpFnB0lN.0TvJ1dWao.JWkJNAg20RM8N.g5FkA0i', NULL, NULL, '2021-07-14 00:32:38', '2021-07-14 00:32:38', 0, 0),
(86, '3456', '$2y$10$cDc4onnoP/D.LrqJEXo0l.vZFdJ2qd1hfXsdSXKxLjzh7Gx/0UANW', NULL, NULL, '2021-07-14 00:32:38', '2021-07-14 00:32:38', 0, 0);
...
(7, NULL, '2213123213', 'laki-laki', 'wqe', '2021-05-11', '8888', '2021', 'v@gmail.com', 9, 3, '2021-07-14 06:26:52', NULL, NULL, NULL, NULL, 0, 0, '2021-05-07 12:59:57', '2021-05-07 12:59:57'),
...
(29, NULL, 'Cupang', 'Laki-laki', 'Banyuwangi', '2021-02-02', '9876', '2021', 'Kaja@kaja.com', 72, 3, '2021-07-14 06:28:15', NULL, NULL, NULL, NULL, 0, 0, '2021-07-13 23:28:15', '2021-07-13 23:28:15'),
(30, NULL, 'Iguana', 'Laki-laki', 'Banyuwangi', '2021-02-02', '8765', '2021', 'Alpha@alpha.com', NULL, 3, '2021-07-14 06:28:15', NULL, NULL, NULL, NULL, 0, 0, '2021-07-13 23:28:15', '2021-07-13 23:28:15'),
(31, NULL, 'Burung', 'Laki-laki', 'Banyuwangi', '2021-02-02', '7654', '2021', 'Uranus@uranus.com', NULL, 3, '2021-07-14 06:28:15', NULL, NULL, NULL, NULL, 0, 0, '2021-07-13 23:28:15', '2021-07-13 23:28:15'),
(39, '1234-Cupang_kiri-crop_image.jpg', 'Cupang kiri', 'laki-laki', 'Banyuwangi', '2021-07-14', '1234', '2021', 'Kaja@kaja.com', 84, 2, '2021-07-14 08:28:42', NULL, NULL, NULL, 2, 0, 0, '2021-07-14 00:32:38', '2021-07-14 01:28:42'),
(40, NULL, 'Iguana', 'Laki-laki', 'Banyuwangi', '2021-07-14', '2345', '2021', 'Alpha@alpha.com', 85, 2, '2021-07-14 07:33:11', NULL, NULL, NULL, 1, 0, 0, '2021-07-14 00:32:38', '2021-07-14 00:32:39'),
(41, NULL, 'Burung', 'Laki-laki', 'Banyuwangi', '2021-07-14', '3456', '2021', 'Uranus@uranus.com', 86, 2, '2021-07-14 07:33:14', NULL, NULL, NULL, 1, 0, 0, '2021-07-14 00:32:38', '2021-07-14 00:32:39');
...
--
-- Indexes for table `kompetensi_dasar_per_kelas`
--
ALTER TABLE `kompetensi_dasar_per_kelas`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `kompetensi_dasar_per_kelas`
--
ALTER TABLE `kompetensi_dasar_per_kelas`

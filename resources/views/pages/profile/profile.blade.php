        ...
        <div class="cover">
          ...
          <div class="cover-body d-flex justify-content-between align-items-center">
            <div>
              ...
              <span class="profile-name">{{ $showUserDetail->name }}</span>
            </div>
      ...
      <div class="card rounded">
        <div class="card-body">
          ...
          <div class="mt-3">
            ...
            <p class="text-muted">{{ $showUserDetail->full_address }}</p>
          </div>
          <div class="mt-3">
            <label class="tx-11 font-weight-bold mb-0 text-uppercase">Email:</label>
            <p class="text-muted">{{ $showUserDetail->email }}</p>
          </div>
          <div class="mt-3">
            <label class="tx-11 font-weight-bold mb-0 text-uppercase">Phone Number:</label>
            <p class="text-muted">{{ $showUserDetail->mobile_phone }}</p>
          </div>
          <div class="mt-3">
            <label class="tx-11 font-weight-bold mb-0 text-uppercase">Role:</label>
            <p class="text-muted">{{ $showRole->name_role }}</p>
          </div>
